...
public class Test{
	...
	while(libwh.isTrue(gY)){
	 ...
	 static Stack<BinTree> f7 (BinTree gX){
		Stack<BinTree> sortie = new Stack<BinTree>();
	...
	while(libwh.isTrue(gY)){
	 ...
	 static Stack<BinTree> f13 (BinTree gX){
		Stack<BinTree> sortie = new Stack<BinTree>();
	...
	while(libwh.isTrue(gY)){
	 ...
	 static Stack<BinTree> f14 (BinTree gX, BinTree gY){
		Stack<BinTree> sortie = new Stack<BinTree>();
	...
	Stack<BinTree> temp;  
	 ...
	 static Stack<BinTree> f12 (BinTree gX, BinTree gY){
		Stack<BinTree> sortie = new Stack<BinTree>();
