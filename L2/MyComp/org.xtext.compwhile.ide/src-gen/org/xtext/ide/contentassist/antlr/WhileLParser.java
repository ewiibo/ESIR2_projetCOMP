...
public class WhileLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, WhileLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExprBaseAccess().getIdentitorAlternatives_9_2_0(), "rule__ExprBase__IdentitorAlternatives_9_2_0");
			...
			builder.put(grammarAccess.getExprBaseAccess().getExprAssignment_9_1(), "rule__ExprBase__ExprAssignment_9_1");
			builder.put(grammarAccess.getExprBaseAccess().getIdentitorAssignment_9_2(), "rule__ExprBase__IdentitorAssignment_9_2");
			builder.put(grammarAccess.getExprBaseAccess().getExpr1Assignment_9_3(), "rule__ExprBase__Expr1Assignment_9_3");
		}
	}
