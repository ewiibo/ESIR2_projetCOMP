 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.whileL.AffectCommand#getVars <em>Vars</em>}</li>
 *   <li>{@link org.xtext.whileL.AffectCommand#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @see org.xtext.whileL.WhileLPackage#getAffectCommand()
 * @model
 * @generated
 */
public interface AffectCommand extends Command
{
   ...
   * @see #setVars(Vars)
   * @see org.xtext.whileL.WhileLPackage#getAffectCommand_Vars()
  ...
  /**
   * Sets the value of the '{@link org.xtext.whileL.AffectCommand#getVars <em>Vars</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setExprs(Exprs)
   * @see org.xtext.whileL.WhileLPackage#getAffectCommand_Exprs()
   * @model containment="true"
   * @generated
   */
  Exprs getExprs();
  ...
  /**
   * Sets the value of the '{@link org.xtext.whileL.AffectCommand#getExprs <em>Exprs</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
