 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.whileL.impl.ExprsImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExprsImpl extends MinimalEObjectImpl.Container implements Exprs
{
  ...
  {
    return WhileLPackage.Literals.EXPRS;
  }
  ...
  public EList<Expr> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expr>(Expr.class, this, WhileLPackage.EXPRS__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WhileLPackage.EXPRS__EXPR:
