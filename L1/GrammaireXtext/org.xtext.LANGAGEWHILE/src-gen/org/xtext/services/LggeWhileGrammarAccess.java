...
@Singleton
public class LggeWhileGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Program");
	...
	public class FunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Function");
	...
	public class DefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Definition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Input");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OutputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Output");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cVarsAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cVarsVARIABLETerminalRuleCall_0_0 = (RuleCall)cVarsAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
	...
	public class CommandsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Commands");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Command");
	...
	public class IfCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.IfCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ForCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.ForCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AffectCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.AffectCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cVarsAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class ForeachCommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.ForeachCommand");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExprsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.Exprs");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.LExpr");
		private final Assignment cExprAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ExprBaseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.ExprBase");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Assignment cIdentitor1Assignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final Keyword cIdentitor1HdKeyword_5_1_0 = (Keyword)cIdentitor1Assignment_5_1.eContents().get(0);
		...
		private final Assignment cIdentitor1Assignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final Keyword cIdentitor1TlKeyword_6_1_0 = (Keyword)cIdentitor1Assignment_6_1.eContents().get(0);
		...
		//	')' | '(' identitor1='hd' expr=Expr ')' | '(' identitor1='tl' expr=Expr ')' | '(' symbol=SYMBOL lexpr=LExpr ')';
		@Override public ParserRule getRule() { return rule; }
		...
		//identitor1='hd'
		public Assignment getIdentitor1Assignment_5_1() { return cIdentitor1Assignment_5_1; }
		
		//'hd'
		public Keyword getIdentitor1HdKeyword_5_1_0() { return cIdentitor1HdKeyword_5_1_0; }
		...
		//identitor1='tl'
		public Assignment getIdentitor1Assignment_6_1() { return cIdentitor1Assignment_6_1; }
		
		//'tl'
		public Keyword getIdentitor1TlKeyword_6_1_0() { return cIdentitor1TlKeyword_6_1_0; }
	...
	@Inject
	public LggeWhileGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.SYMBOL");
		this.tVARIABLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.LggeWhile.VARIABLE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.xtext.LggeWhile".equals(grammar.getName())) {
				return grammar;
			}
