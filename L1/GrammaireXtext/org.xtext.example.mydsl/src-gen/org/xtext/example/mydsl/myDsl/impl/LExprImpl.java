 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.LExprImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LExprImpl extends ExprBaseImpl implements LExpr
{
  ...
  public EList<Expr> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expr>(Expr.class, this, MyDslPackage.LEXPR__EXPR);
    }
    return expr;
  }
